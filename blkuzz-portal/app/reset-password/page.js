...
function ResetPasswordForm() {
  ...
  if (!token) {
    return <p className="text-center text-sm" style={{ color: '#FF0000' }}>This reset link is missing a token. Please request a new one from the <a href="/portal/forgot-password" className="text-gold underline">forgot password</a> page.</p>
  }
