          ...
          {filtered.map(m => (
            <div key={m._id} onMouseDown={e => { e.preventDefault(); add(m) }}
              ...
              <div>
                ...
                {m.discipline && <div style={{ fontFamily: MONO, fontSize: 7, color: '#444', letterSpacing: '0.05em' }}>{m.discipline}</div>}
              </div>
            </div>
          ))}
        </div>
...
function MediaUpload({ files, onChange }) {
  ...
  return (
    <div>
      ...
      >
        <span style={{ fontFamily: MONO, fontSize: 14, color: '#444', lineHeight: 1 }}>+</span>
        <span style={{ fontFamily: MONO, fontSize: 9, color: '#555', letterSpacing: '0.1em' }}>
...
function Label({ children, required }) {
  return (
    <div style={{ fontFamily: MONO, fontSize: 7, letterSpacing: '0.2em', color: '#555', textTransform: 'uppercase', marginBottom: 6, display: 'flex', justifyContent: 'space-between' }}>
      <span>{children}</span>
      ...
      <div style={{ flex: 1, display: 'flex', minHeight: 0 }}>
        ...
        <div style={{ width: '44%', borderRight: '1px solid #141414', overflowY: 'auto', scrollbarWidth: 'none', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ display: 'flex', borderBottom: '1px solid #141414', flexShrink: 0 }}>
            {[
              ...
              <div key={i} style={{ flex: 1, padding: '18px 0', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 5, borderRight: i < arr.length - 1 ? '1px solid #141414' : 'none' }}>
                ...
                <div style={{ fontFamily: MONO, fontSize: 7, letterSpacing: '0.12em', color: '#333', textTransform: 'uppercase', textAlign: 'center', lineHeight: 1.5, whiteSpace: 'pre-line' }}>{s.label}</div>
              </div>
            ))}
          </div>
          ...
          <div style={{ padding: '24px 24px 32px', flex: 1 }}>
            <div style={{ fontFamily: MONO, fontSize: 7, letterSpacing: '0.3em', color: '#2a2a2a', textTransform: 'uppercase', marginBottom: 16, display: 'flex', alignItems: 'center', gap: 8 }}>
              What selection means
        ...
        <div style={{ flex: 1, overflowY: 'auto', scrollbarWidth: 'none', display: 'flex', flexDirection: 'column' }}>
          ...
          {loading ? (
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 24, padding: '40px 48px', textAlign: 'center' }}>
              ...
              <div style={{ fontFamily: MONO, fontSize: 9, color: '#444', letterSpacing: '0.12em', lineHeight: 2 }}>
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 12, padding: 48, textAlign: 'center' }}>
              ...
              <div style={{ fontFamily: SERIF, fontSize: 20, color: '#444', fontStyle: 'italic' }}>Check back next quarter.</div>
            </div>
            ...
            <div style={{ padding: '40px 48px' }}>
              ...
              <form onSubmit={submit}>
                ...
                <div style={{ marginBottom: 18 }}>
                  ...
                  <div style={{ fontFamily: MONO, fontSize: 9, color: '#555', letterSpacing: '0.08em', marginBottom: 10 }}>Is this an existing Blkuzz project?</div>
                  ...
                  {form.existingProject === true && (
                    <div style={{ marginTop: 10 }}>
                      {myProjects.length === 0 ? (
                        <div style={{ fontFamily: MONO, fontSize: 8, color: '#333', padding: '10px 12px', border: '1px solid #1e1e1e' }}>No projects found in your account.</div>
                      ) : (
                        <ProjectSelect
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 14 }}>
                  ...
                  <div style={{ fontFamily: MONO, fontSize: 7, color: '#2a2a2a', letterSpacing: '0.1em', textAlign: 'center', lineHeight: 1.9 }}>
