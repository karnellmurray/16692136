...
export default function ReportBugPage() {
  ...
  return (
    <div style={{ maxWidth: 560, margin: '0 auto', padding: '32px 24px' }}>
      <button onClick={() => router.back()} style={{ display: 'flex', alignItems: 'center', gap: 8, background: 'transparent', border: 'none', color: 'rgba(255,255,255,0.4)', cursor: 'pointer', marginBottom: 28, fontFamily: MONO, fontSize: 10, letterSpacing: '0.15em' }}>
        <ArrowLeft size={15} /> BACK
      </button>

      <h1 className="font-head" style={{ fontSize: 20, color: '#FDC214', letterSpacing: '3px', marginBottom: 8 }}>REPORT BUGS</h1>
      <p style={{ fontFamily: MONO, fontSize: 11, color: 'rgba(255,255,255,0.4)', letterSpacing: '0.05em', lineHeight: 1.6, marginBottom: 28 }}>
      ...
      {sent ? (
        <div style={{ padding: '32px 0', textAlign: 'center' }}>
          ...
          <button onClick={() => router.back()}
            style={{ padding: '10px 24px', background: 'transparent', border: '1px solid #333', color: 'rgba(255,255,255,0.6)', fontFamily: MONO, fontSize: 11, letterSpacing: '0.1em', cursor: 'pointer' }}>
            BACK TO SETTINGS
          </button>
        </div>
      ) : (
        <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          <div>
            <label style={{ display: 'block', fontFamily: MONO, fontSize: 10, letterSpacing: '0.15em', color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', marginBottom: 8 }}>
              Subject
            </label>
          ...
          <div>
            ...
            <p style={{ fontFamily: MONO, fontSize: 10, color: 'rgba(255,255,255,0.3)', marginTop: 6, textAlign: 'right' }}>
          ...
          <button type="submit" disabled={!canSubmit}
            style={{ alignSelf: 'flex-start', padding: '12px 30px', background: canSubmit ? '#FDC214' : '#333', color: canSubmit ? '#0a0a0a' : 'rgba(255,255,255,0.4)', border: 'none', borderRadius: 9999, fontFamily: 'IBM Plex Mono, monospace', fontSize: 12, letterSpacing: '0.15em', textTransform: 'uppercase', cursor: canSubmit ? 'pointer' : 'default' }}>
